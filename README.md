# E09a-First-Person-Character for MSCH220 Indiana University 2020

# The purpose of this exercise is for you to create a 3D first-person character in Godot. 

# Below are the instructions.

As this is your first 3D project in Godot, we will start slowly, giving you an opportunity to become accustomed to the environment and some of the concepts associate with building a 3D game.
